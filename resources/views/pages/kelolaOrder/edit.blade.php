                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="service_type" class="form-control">
                                            ...
                                            <option value="Drop Off"
                                                {{ $order->service_type == 'Drop Off' ? 'selected' : '' }}>
                                                Drop Off</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" step="0.1" id="berat" name="berat"
                                            class="form-control" value="{{ $order->berat }}">
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" id="total_biaya" name="total_biaya" class="form-control"
                                            readonly value="{{ $order->total_biaya }}">
                                    </div>
