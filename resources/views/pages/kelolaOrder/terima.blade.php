            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <h6 class="text-dark">
                                Waktu Sekarang (WIB): <span id="current-wib-time" class="text-primary font-weight-bold"></span>
                            </h6>
                        </div>
                            ...
                            <table class="table table-bordered table-hover table-md">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="timer-{{ $order->id }}" class="text-danger font-weight-bold"
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-sm btn-icon btn-primary" title="Ubah Status"
                                                data-toggle="modal" data-target="#ubahStatusModal{{ $order->id }}">
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="7" class="text-center">Tidak ada data order diterima.</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
