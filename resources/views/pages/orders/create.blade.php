                ...
                <form action="{{ route('order.store') }}" method="POST">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {{-- Self Service Fields --}}
                            <div id="self-service-fields" style="display: none;">
                                <div class="form-group">
                                    <label for="mesin_id">Pilih Mesin</label>
                                    <select id="mesin_id" name="mesin_id" class="form-control">
                            ...
                            {{-- Drop Off Fields --}}
                            <div id="drop-off-fields" style="display: none;">
                                <div class="form-group">
                                    <label for="berat">Berat Cucian (kg)</label>
                                    <input type="number" name="berat" id="berat" class="form-control" step="0.1"
                                        min="0" value="0">
                                </div>
                                <div class="form-group">
...
@push('scripts')
    <script>
        function toggleFields() {
            ...
            const dropOffFields = document.getElementById('drop-off-fields');
        ...
        function hitungTotal() {
            ...
            if (type === 'Self Service') {
                ...
                total += (berat * 31000) + (detergent * 1000);
            }
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            toggleFields(); // Inisialisasi tampilan
        });
    </script>
@endpush
