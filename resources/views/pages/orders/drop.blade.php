                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_order" id="tanggal_order" class="form-control" value="{{ date('Y-m-d') }}" required>
                        </div>

                        <div class="form-group">
                            <label for="jam_order">Jam Order</label>
                            <input type="time" name="jam_order" id="jam_order" class="form-control" value="{{ date('H:i') }}" required>
                        </div>

                        <div class="form-group">
                            <label for="berat">Berat Cucian (kg)</label>
                            <input type="number" name="berat" id="berat" class="form-control" step="0.1" min="0" value="0" required>
                        </div>

                        <div class="form-group">
                            <label for="detergent">Jumlah Detergent</label>
                            <input type="number" name="detergent" id="detergent" class="form-control" min="0" value="0" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="total_biaya_display" class="form-control" readonly>
