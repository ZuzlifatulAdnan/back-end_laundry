    ...
    <div class="main-content">
        @if (Auth::user()->role == 'Admin')
            <section class="section">
                <form action="{{ route('kelolaPembayaran.update', $pembayaran->id) }}" method="POST"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="file" name="bukti_bayar" accept="image/*" class="form-control"
                                        onchange="previewImage(event)">
                                    <br>
                                    @if ($pembayaran->bukti_bayar)
                                        <p class="mt-2">Bukti Lama:</p>
                                        <img src="{{ asset('img/bukti_bayar/' . $pembayaran->bukti_bayar) }}"
                                            alt="Bukti Lama" style="max-width: 300px; display:block; margin-bottom:10px;">
                                    @endif
