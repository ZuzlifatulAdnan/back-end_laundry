                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p>
                                    <span class="badge 
                                        {{ $kelolaPembayaran->status == 'Pembayaran Berhasil' ? 'badge-success' : 
                                           ($kelolaPembayaran->status == 'Proses Pembayaran' ? 'badge-warning' : 'badge-secondary') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <p>{{ \Carbon\Carbon::parse($kelolaPembayaran->created_at)->translatedFormat('d M Y') }}</p>
                            </div>

                            <div class="col-12">
                                <strong>Bukti Bayar</strong><br>
                                @if ($kelolaPembayaran->bukti_bayar)
                                    <img src="{{ asset('img/bukti_bayar/' . $kelolaPembayaran->bukti_bayar) }}" alt="Bukti Bayar"
                                         style="max-width: 400px; margin-top: 10px;" class="img-thumbnail">
                                @else
