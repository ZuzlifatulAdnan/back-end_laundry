                ...
                <div class="section-body">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <dl class="row">
                                ...
                                <dd class="col-sm-9">{{ \Carbon\Carbon::parse($order->tanggal_order)->format('d/m/Y') }}
                                </dd>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            ...
                            @if ($pembayaran)
                                <dl class="row">
                                    <dt class="col-sm-3">No Pembayaran</dt>
                                    <dd class="col-sm-9">{{ ucfirst($pembayaran->no_pembayaran) }}</dd>
                                    ...
                                    <dd class="col-sm-9">Rp {{ number_format($pembayaran->jumlah_dibayar, 0, ',', '.') }}
                                    </dd>
                                    ...
                                    @if ($pembayaran->bukti_bayar)
                                        ...
                                        <dd class="col-sm-9">
                                            <img src="{{ asset('img/bukti_bayar/' . $pembayaran->bukti_bayar) }}"
                                                alt="Bukti Bayar" class="img-fluid" style="max-height: 200px;">
                                        </dd>
                                    @endif
                                </dl>
